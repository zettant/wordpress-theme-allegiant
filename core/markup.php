...
if(!function_exists('cpotheme_footer')){
	function cpotheme_footer(){		
		...
		echo '<h3 align="left">株式会社ゼタント</h3>';
		echo '<h6 align="left">〒103-0023 東京都中央区日本橋本町4－8－16 千城ビル5階 BcH</h6>';
		echo '<h3 align="left">Zettant Inc.</h3>';
		echo '<h6 align="left">';
		echo 'Senjo-Bldg 5F BcH, 4-8-16 Nihonbashi Honcho, Chuou-ku, Tokyo 103-0023, Japan</h6>';
		echo '<a href="https://www.zettant.com/?cpo_portfolio=privacy-policy "target="_blank"　>プライバシーポリシー</a><br>'; 
		echo '&copy; '.get_bloginfo('name').' '.date("Y").'. reserved.'; 
		echo '</div>';
	}
}
